...
class SlamProcess:
    ...
    def update(self, dataContainer, possHintWorld, map_without_matching=False):
        ...
        if self.poseDifferenceLargerThan(newPoseEstimateWorld, self.lastMapUpdatePose, self.paramMinDistanceDiffForMapUpdate, self.paramMinAngleDiffForMapUpdate) or map_without_matching:
