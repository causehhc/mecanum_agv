...
#ifndef BISHE_STM32_DISPLAY_H
#define BISHE_STM32_DISPLAY_H
...
void OLED_ShowString_cnt(uint8_t x,uint8_t y,uint8_t *chr,uint8_t Char_Size, uint8_t cnt);
void OLED_preFlash();

#endif //BISHE_STM32_DISPLAY_H
