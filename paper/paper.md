...
#### 2.2.2、移动
本项目定义为具有特定用途的物理实体，最为显性的需求即移动。
**TODO**
#### 2.2.3、定位与建图
本项目定义为可以工作在已知或未知平面区域内的运动实体，关键在于运动实体能否准确判断当前所处位置并同时对全局区域信息进行记录，这项技术被称为同步定位与地图构建（Simultaneous localization and mapping, SLAM），是本项目的核心。
**TODO**
#### 2.2.4、导航
本项目定义为可半自主运动的环境感知实体，即意味着该实体能够根据已知信息，通过某种算法得出起始点和目标点之间的一条可行路线，并根据环境与实体的具体情况将这条路线进行优化，满足实际需要。
**TODO**
#### 2.2.5、交互
本项目定义为具有任务规划功能的执行单元，并且任务规划这一特性需要人工介入，所以项目需要一种合理的人机交互方式。
**TODO**
### 2.3、可行性分析
#### 2.3.1、技术可行性
